...
function Contact() {
    return (
        <section className="py:rel:10 w:65 h:80% m:auto bg:creamsicle-100 flex col" id="contact">
            <h2 className="text:xlg text:center">Let's Talk over a nice Diet Coke</h2>
            <form
                className="flex col justify:items w:45 m:auto"
                method="post"
            >
            ...
            <a className="text:center justify:items [end] mt:10" href="#main-nav">Back to Top</a>
        </section>
    );
}
